...
转自：http://www.wowotech.net/memory_management/458.html

# 浅谈Cache Memory

今天探究的主题是cache。我们围绕几个问题展开。为什么需要cache？如何判断一个数据在cache中是否命中？cache的种类有哪些，区别是什么？

> 我在知乎平台发起了一个[高速缓存专题](https://zhuanlan.zhihu.com/cpu-cache)，感兴趣的可以关注。
...
[![图片1.jpg](http://www.wowotech.net/content/uploadfile/201905/0fe51556803037.jpg)](http://www.wowotech.net/content/uploadfile/201905/0fe51556803037.jpg)

其实现实中，CPU通用寄存器的速度和主存之间存在着太大的差异。两者之间的速度大致如下关系：

[![图片2.jpg](http://www.wowotech.net/content/uploadfile/201905/40261556803038.jpg)](http://www.wowotech.net/content/uploadfile/201905/40261556803038.jpg)
...
[![图片3.jpg](http://www.wowotech.net/content/uploadfile/201905/61611556803039.jpg)](http://www.wowotech.net/content/uploadfile/201905/61611556803039.jpg)
...
[![图片4.jpg](http://www.wowotech.net/content/uploadfile/201905/3d2f1556803040.jpg)](http://www.wowotech.net/content/uploadfile/201905/3d2f1556803040.jpg)

经过3级cache的缓冲，各级cache和主存之间的速度最萌差也逐级减小。在一个真实的系统上，各级cache之间硬件上是如何关联的呢？我们看下Cortex-A53架构上各级cache之间的硬件抽象框图如下：

[![图片5.png](http://www.wowotech.net/content/uploadfile/201905/95101556803041.png)](http://www.wowotech.net/content/uploadfile/201905/95101556803041.png)
...
[![图片6.png](http://www.wowotech.net/content/uploadfile/201905/560d1556803043.png)](http://www.wowotech.net/content/uploadfile/201905/560d1556803043.png)
...
[![图片7.png](http://www.wowotech.net/content/uploadfile/201905/1e1b1556803044.png)](http://www.wowotech.net/content/uploadfile/201905/1e1b1556803044.png)
...
现在我们考虑一个问题，CPU从0x0654地址读取一个字节，cache控制器是如何判断数据是否在cache中命中呢？cache大小相对于主存来说，可谓是小巫见大巫。所以cache肯定是只能缓存主存中极小一部分数据。我们如何根据地址在有限大小的cache中查找数据呢？现在硬件采取的做法是对地址进行散列（可以理解成地址取模操作）。我们接下来看看是如何做到的？
 ...
 [![图片8.png](http://www.wowotech.net/content/uploadfile/201906/914f1559459886.png)](http://www.wowotech.net/content/uploadfile/201906/914f1559459886.png)
...
上面的例子中，cache size是64 Bytes并且cache line size是8 bytes。offset、index和tag分别使用3 bits、3 bits和42 bits（假设地址宽度是48 bits）。我们现在再看一个例子：512 Bytes cache size，64 Bytes cache line size。根据之前的地址划分方法，offset、index和tag分别使用6 bits、3 bits和39 bits。如下图所示。
 ...
 [![图片9.png](http://www.wowotech.net/content/uploadfile/201906/4d7c1559460437.png)](http://www.wowotech.net/content/uploadfile/201906/4d7c1559460437.png)

## 直接映射缓存的优缺点

直接映射缓存在硬件设计上会更加简单，因此成本上也会较低。根据直接映射缓存的工作方式，我们可以画出主存地址0x00-0x88地址对应的cache分布图。

[![图片10.png](http://www.wowotech.net/content/uploadfile/201905/124d1556803046.png)](http://www.wowotech.net/content/uploadfile/201905/124d1556803046.png)
...
我们依然假设64 Bytes cache size，cache line size是8 Bytes。什么是路（way）的概念。我们将cache平均分成多份，每一份就是一路。因此，两路组相连缓存就是将cache平均分成2份，每份32 Bytes。如下图所示。
 ...
 [![图片11.png](http://www.wowotech.net/content/uploadfile/201906/72da1559460472.png)](http://www.wowotech.net/content/uploadfile/201906/72da1559460472.png)
...
[![图片12.png](http://www.wowotech.net/content/uploadfile/201905/796f1556803048.png)](http://www.wowotech.net/content/uploadfile/201905/796f1556803048.png)
...
[![图片13.png](http://www.wowotech.net/content/uploadfile/201905/2d091556803049.png)](http://www.wowotech.net/content/uploadfile/201905/2d091556803049.png)
...
[![图片14.png](http://www.wowotech.net/content/uploadfile/201905/0d481556803050.png)](http://www.wowotech.net/content/uploadfile/201905/0d481556803050.png)
...
1. 写直通（write through）：
   ...
   [![图片15.png](http://www.wowotech.net/content/uploadfile/201905/8a331556803051.png)](http://www.wowotech.net/content/uploadfile/201905/8a331556803051.png)
...
2. 写回（write back）：
   ...
   [![图片16.png](http://www.wowotech.net/content/uploadfile/201905/a66d1556803052.png)](http://www.wowotech.net/content/uploadfile/201905/a66d1556803052.png)

## 实例

假设我们有一个64 Bytes大小直接映射缓存，cache line大小是8 Bytes，采用写分配和写回机制。当CPU从地址0x2a读取一个字节，cache中的数据将会如何变化呢？假设当前cache状态如下图所示。

[![图片17.png](http://www.wowotech.net/content/uploadfile/201905/b53b1556803053.png)](http://www.wowotech.net/content/uploadfile/201905/b53b1556803053.png)
...
[![图片18.png](http://www.wowotech.net/content/uploadfile/201905/afb81556803055.png)](http://www.wowotech.net/content/uploadfile/201905/afb81556803055.png)
