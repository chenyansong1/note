...
private[deploy] class ExecutorRunner(
  ...
  private[worker] def start() {
    // 在executorRunner中会启动一个线程，在该线程中去使用启动命令启动：CoarseGrainedExecutorBackend 这个executor
...
//
      ...
      "-cp"
      "/usr/hadoop/spark-2.0.2-bin-hadoop2.6/conf/:/usr/hadoop/spark-2.0.2-bin-hadoop2.6/jars/*"
      "-Xmx1024M"
      "-Dspark.driver.port=63869"
      "org.apache.spark.executor.CoarseGrainedExecutorBackend"
      "--driver-url" "spark://CoarseGrainedScheduler@169.254.234.75:63869"
      "--executor-id" "0"
      "--hostname" "172.16.14.31"
      "--cores" "6"
      "--app-id" "app-20180202172830-2601"
      "--worker-url" "spark://Worker@172.16.14.31:56455"
//
