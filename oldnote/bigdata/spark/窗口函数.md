...
![](http://ols7leonh.bkt.clouddn.com//assert/img/bigdata/spark/spark_streaming/5.png)
...
object WindowOpts {
  ...
  def main(args: Array[String]) {
    ...
    val windowedWordCounts = pairs.reduceByKeyAndWindow((a:Int,b:Int) => (a + b), Seconds(15), Seconds(10))//窗口长度15秒,滑动的时间间隔10秒 ,这两个时间必须是5000ms的倍数
